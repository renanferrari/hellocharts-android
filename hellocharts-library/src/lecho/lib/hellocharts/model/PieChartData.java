...
public class PieChartData extends AbstractChartData {
  ...
  public static final float DEFAULT_TRANSLUCENT_CIRCLE_SCALE = 0.4f;
  public static final float DEFAULT_TRANSLUCENT_CIRCLE_OPACITY = 0.2f;
  ...
  private float translucentCircleScale = DEFAULT_TRANSLUCENT_CIRCLE_SCALE;
  ...
  private boolean hasTranslucentCircle = false;
  private int centerCircleColor = Color.TRANSPARENT;
  private int translucentCircleColor = Color.WHITE;
  private float translucentCircleOpacity = DEFAULT_TRANSLUCENT_CIRCLE_OPACITY;
  ...
  public PieChartData(PieChartData data) {
    ...
    this.hasTranslucentCircle = data.hasTranslucentCircle;
    this.translucentCircleColor = data.translucentCircleColor;
    this.translucentCircleScale = data.translucentCircleScale;
    this.translucentCircleOpacity = data.translucentCircleOpacity;
  ...
  @Override public void update(float scale) {
   ...
   */
  @Override public void setAxisXBottom(Axis axisX) {
   ...
   * PieChart does not support axes so method call will be ignored
   */
  @Override public void setAxisYLeft(Axis axisY) {
  ...
  /**
   * Set if labels should be drawn inside circle(false) or outside(true). By default false. If you
   * set it to true you
  ...
  public boolean hasTranslucentCircle() {
    return hasTranslucentCircle;
  }

  public PieChartData setHasTranslucentCircle(boolean hasTranslucentCircle) {
    this.hasTranslucentCircle = hasTranslucentCircle;
    return this;
  }

  /**
   * @see #setTranslucentCircleColor(int)
   */
  public int getTranslucentCircleColor() {
    return translucentCircleColor;
  }

  /**
   * Set the color of translucent circle. Default is white.
   *
   * Note that if the color already has some transparency,
   * #setTranslucentCircleOpacity(float) will be ignored.
   */
  public PieChartData setTranslucentCircleColor(int translucentCircleColor) {
    this.translucentCircleColor = translucentCircleColor;
    return this;
  }

  /**
   * @see #setTranslucentCircleOpacity(float)
   */
  public float getTranslucentCircleOpacity() {
    return translucentCircleOpacity;
  }

  /**
   * Set the translucent circle color's opacity. Value should be between 0 and 1.
   * Default is 0.2, meaning the color will have 20% opacity (80% transparency).
   *
   * If the color set with #setTranslucentCircleColor(int) already has some transparency,
   * then this method won't have any effect.
   */
  public PieChartData setTranslucentCircleOpacity(float translucentCircleOpacity) {
    this.translucentCircleOpacity = translucentCircleOpacity;
    return this;
  }

  public float getTranslucentCircleScale() {
    return translucentCircleScale;
  }

  public PieChartData setTranslucentCircleScale(float translucentCircleScale) {
    this.translucentCircleScale = translucentCircleScale;
    return this;
  }
